...
register_activation_hook(__FILE__, ['Cron_Handler', 'schedule_sync']);

// Unschedule the sync when plugin is deactivated
register_deactivation_hook(__FILE__, ['Cron_Handler', 'unschedule_sync']);

// Hook the sync function to the cron event
add_action('zoho_woocommerce_sync_event', ['Cron_Handler', 'perform_sync']);